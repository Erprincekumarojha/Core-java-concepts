...
What is Thread:
                  1.A thread is an independent sequential flow of execution path
                  2.It executes methods in sequence one after one.
				  3.In a single JVA we can create multiple threads to have multiple
                     independent flow of execution paths to execute multiple tasks
					 at a time concurrentily.
 
Need of this chapter:
     ->In this chapter, Multithreading, we will learnt executing multiple tasks 
	 sequentily.

Multitasking:- 
                The process of executing multiple tasks at a time concurrentily.
				is called a multitasking.
